...
import * as DelegateContract from '@airswap/delegate-erc20/build/contracts/DelegateERC20.sol/DelegateERC20.json'
import * as delegateDeploys from '@airswap/delegate-erc20/deploys.js'
